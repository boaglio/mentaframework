 ...
 *
 * Generated on Nov 8, 2007 6:41:15 PM
 * Time to generate: 00:33.466 seconds
 *
 */
...
public class OracleBeanSessionAgitarTest extends AgitarTestCase {
    
    public Class getTargetClass()  {
        return OracleBeanSession.class;
    }
    
    public void testConstructor() throws Throwable {
        OracleBeanSession oracleBeanSession = new OracleBeanSession();
        assertEquals("oracleBeanSession.loaded.size()", 0, oracleBeanSession.loaded.size());
        assertNull("oracleBeanSession.appManager", oracleBeanSession.appManager);
    }
    
    public void testConstructor1() throws Throwable {
        OracleBeanSession oracleBeanSession = new OracleBeanSession(null);
        assertNull("oracleBeanSession.conn", oracleBeanSession.conn);
        assertEquals("oracleBeanSession.loaded.size()", 0, oracleBeanSession.loaded.size());
        assertNull("oracleBeanSession.appManager", oracleBeanSession.appManager);
    }
    ...
    public void testGetNow() throws Throwable {
        OracleBeanSession oracleBeanSession = new OracleBeanSession();
        String result = oracleBeanSession.getNow();
        assertEquals("result", "sysdate", result);
    }
    
    public void testHandleLimit() throws Throwable {
        OracleBeanSession oracleBeanSession = new OracleBeanSession();
        StringBuilder result = oracleBeanSession.handleLimit(new StringBuilder("testOracleBeanSessionParam1"), "testOracleBeanSessionOrderBy", -1);
        assertEquals("result.length()", 27, result.length());
    }
    
    public void testHandleLimit1() throws Throwable {
        OracleBeanSession oracleBeanSession = new OracleBeanSession();
        StringBuilder sb = new StringBuilder();
        sb.append("testOracleBeanSessionParam1");
        StringBuilder result = oracleBeanSession.handleLimit(sb, "testOracleBeanSessionOrderBy", 0);
        assertEquals("result.length()", 63, result.length());
    }
    
    public void testHandleLimit2() throws Throwable {
        OracleBeanSession oracleBeanSession = new OracleBeanSession();
        StringBuilder result = oracleBeanSession.handleLimit(new StringBuilder("testOracleBeanSessionParam1"), "testOracleBeanSessionOrderBy", -2);
        assertEquals("result.length()", 64, result.length());
    }
    
    public void testHandleLimit3() throws Throwable {
        OracleBeanSession oracleBeanSession = new OracleBeanSession();
        StringBuilder sb = new StringBuilder();
        sb.append("testOracleBeanSessionParam1");
        StringBuilder result = oracleBeanSession.handleLimit(sb, null, 0);
        assertEquals("result.length()", 43, result.length());
    }
    
    public void testHandleLimit4() throws Throwable {
        OracleBeanSession oracleBeanSession = new OracleBeanSession(null);
        StringBuilder result = oracleBeanSession.handleLimit(null, "testOracleBeanSessionOrderBy", -1);
        assertNull("result", result);
    }
    
    public void testInsertWithAggressiveMocks() throws Throwable {
        storeStaticField(JdbcBeanSession.class, "DEBUG");
        OracleBeanSession oracleBeanSession = (OracleBeanSession) Mockingbird.getProxyObject(OracleBeanSession.class, true);
        ...
        setPrivateField(oracleBeanSession, "appManager", applicationManager);
        oracleBeanSession.conn = connection;
        oracleBeanSession.loaded = identityHashMap;
        ...
        Mockingbird.setReturnValue(true, JdbcBeanSession.class, "getValueFromBean", "(java.lang.Object,java.lang.String)java.lang.Object", null, 1);
        Mockingbird.setReturnValue(oracleBeanSession.getNow(), null);
        ...
        Mockingbird.setReturnValue(oracleBeanSession.getNow(), "");
        Mockingbird.setReturnValue(oracleBeanSession.getNow(), "");
        ...
        Mockingbird.enterTestMode(OracleBeanSession.class);
        oracleBeanSession.insert(obj);
    ...
    public void testInsertWithAggressiveMocks1() throws Throwable {
        ...
        setPrivateField(dBField3, "name", "");
        setPrivateField(dBField3, "dbName", "");
        setPrivateField(dBField3, "type", autoIncrementType2);
        setPrivateField(dBField4, "name", "");
        setPrivateField(dBField4, "dbName", "");
        ...
        setPrivateField(obj7, "field", dBField13);
    ...
    public void testHandleLimitThrowsNullPointerException() throws Throwable {
        OracleBeanSession oracleBeanSession = new OracleBeanSession(null);
        try {
            oracleBeanSession.handleLimit(null, "testOracleBeanSessionOrderBy", 0);
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(OracleBeanSession.class, ex);
        }
    }
    ...
    public void testInsertThrowsBeanExceptionWithAggressiveMocks() throws Throwable {
        ...
        try {
            ...
            assertEquals("oracleBeanSession.getNow()", "sysdate", oracleBeanSession.getNow());
        }
    }
