...
<div id="subheader">
  <a href="http://ajaxtags.sourceforge.net/" target="_top" style="background: url(./img/external.png) right center no-repeat; padding-right: 15px;">Project website</a>
  | <a href="http://sourceforge.net/projects/ajaxtags/" target="_top" style="background: url(./img/external.png) right center no-repeat; padding-right: 15px;">AjaxTags@SourceForge</a>
</div>
<div id="buildVersion">Using Project Version 1.2</div>
